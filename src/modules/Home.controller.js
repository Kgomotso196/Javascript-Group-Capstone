...
export const paginationHandler = (movieList) => {
  const maxPage = Math.ceil(
    movieList.length / defaultConfig.PAGINATION_ITEM_PER_PAGE,
  );
  set('maxPage', maxPage);
  return maxPage;
};

export const renderMovieHandler = (Database) => currentData(Database)
  .map(
...
export const renderPaginationHandler = (
  ListOfmovies,
